...
# ------------------- District Layout Logic -------------------
if layout_level == "district":
...
arcpy.AddMessage("🏁 All districts processed. Total exported: {0}".format(exported_count))
