...
for watershed_name in unique_watershed:
    ...
    for subwatershed_index, subwatershed_name in enumerate(highlight_subwatershed, 1):
        ...
        for miniwatershed_index, miniwatershed_name in enumerate(miniwatershed_names, 1):
            ...
            miniwatershed_query = "{0} = '{1}' AND {2} = '{3}'".format(
                subwatershed_field, subwatershed_name.replace("'", "''"),
                miniwatershed_field, miniwatershed_name.replace("'", "''")
            )
            ...
            out_name = f"{safe_miniwatershed}_{safe_subwatershed}.pagx"
...
arcpy.AddMessage("\n🌟 All miniwatershed layouts exported successfully. Total exported: {0}".format(exported_count))
